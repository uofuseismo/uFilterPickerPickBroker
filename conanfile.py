...
class uFilterPickerPickBrokerConan(ConanFile):
   name = "uFilterPickerPickBroker"
   #version = "0.0.1"
   license = "MIT"
   description = "A destination for picks generated by the Lomax-style filter picker in the UUSS Kubernetes environment."
   url = "https://github.com/uofuseismo/uFilterPickerPickBroker"
   #topics = ("uFilterPickerPickBroker")
   ...
   def package_info(self):
       self.cpp_info.libs = ["uFilterPickerPickBroker"]
